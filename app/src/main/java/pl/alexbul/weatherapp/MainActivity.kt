...
import pl.alexbul.weatherapp.data.WeatherModel
...
const val API_KEY = "77a1e167522c407694d195815240101"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            WeatherAppTheme {
                ...
                Column {
                    MainCard(currentDay, onClickSearch = {dialogState.value = true},
                        onClickSync =
                    {getData("London", this@MainActivity,
                        daysList, currentDay)})
